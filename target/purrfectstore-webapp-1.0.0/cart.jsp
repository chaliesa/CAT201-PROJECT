            ...
            <div class="cart-container">
                ...
                <div class="cart-summary">
                    ...
                    <form method="get" action="payment.jsp">
                         <input type="hidden" name="total" value="<%= String.format("%.2f", subtotal + (subtotal > 0 ? 15.0 : 0.0) + subtotal * 0.08) %>">
        
                         <% if (subtotal > 0) { %>
                            <button type="submit" class="checkout-btn">Proceed to Payment</button>
                         <% } else { %>
                                <button type="button" class="checkout-btn" disabled style="background-color:gray;">Cart is Empty</button>
                         <% } %>
                    </form>
